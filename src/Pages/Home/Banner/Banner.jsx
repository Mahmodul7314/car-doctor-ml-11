...
const Banner = () => {
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute flex items-center left-0 top-0 rounded-lg h-full bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
             <div className="text-white space-y-7 pl-12 w-1/3">
              <h2 className="text-6xl font-bold">Affordable Price for Car Servicing</h2>
              <p>There are may Variation of passagees of availabel, but the majority have suffered alteration in some form</p>
              <div>
